...
class FullyConnectedLayer(object):
    ...
    #     self.d_weight= self.input * np.gradient(top_diff,self.output).T
    #     self.d_bias= np.gradient(top_diff,self.output)
    #     bottom_diff= self.weight.T @ np.gradient(top_diff,self.output)
