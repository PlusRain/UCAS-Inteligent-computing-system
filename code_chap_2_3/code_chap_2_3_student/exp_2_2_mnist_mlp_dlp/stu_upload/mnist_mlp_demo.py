...
class MNIST_MLP(object):
    ...
    def build_model(self, batch_size=100, input_size=784, 
        ...
        input_shapesoftmax  = pycnnl.IntVector(3)
        input_shapesoftmax[0] = batch_size
        input_shapesoftmax[1] = 1
        input_shapesoftmax[2] = out_classes
        ...
        self.net.createSoftmaxLayer("softmax",input_shapesoftmax,axis=1)
